    ...
    public function saveAccomplishmentReport(Request $request, $id = null)
{
    ...
    try {
        ...
        $accomplishmentReport = Accomplishment_Report::where('control_request_id', $existingRequest->id)->first();
        ...
        Accomplishment_Report::where('control_request_id', $existingRequest->id)
