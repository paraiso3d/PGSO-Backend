    ...
    public function saveFeedback(Request $request, $id = null)
{
    ...
    try {
        ...
        $feedbackData = [
            ...
            'date_started' => $existingAccomplishment->date_started ?? Carbon::now(), // set default if not present
            'date_completed' => $existingAccomplishment->date_completed // keep existing value
        ];
