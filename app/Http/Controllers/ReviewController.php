...
class ReviewController extends Controller
{
    ...
    public function updateReview(Request $request, $id = null)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'overtime' => 'nullable|string|in:Yes,No', // Update to explicitly check for 'Yes' or 'No'
        ...
        try {
            ...
            $reviewChangeData = [
                ...
                'officename' => $fullOfficeName, // Store the full office name
            ...
            // Update the Requests table if the overtime field has changed
            if ($overtimeUpdated) {
                $existingRequest->update(['overtime' => $request->input('overtime')]);
            }
